/* 멍스쿨 모바일 — 카밍 시그널 라이브러리
   ...
   pose(t, ex) 는 벡터 얼굴 파라미터를 돌려준다. ex = 과장 계수(1=최대, 0=실제 크기).
   ★과장은 «얼마나»에만 건다. 신호의 종류와 방향은 실제 그대로. (아트 디렉션 스펙 v2) */

import { FACES } from './pup.js';
...
export const SIGNALS = [
  {
    ...
    mean: '지금 마음이 편해요',
    todo: '하던 걸 계속해도 좋아요',
    pose: (t, ex) => FACES.relaxed(ex == null ? 1 : ex),
  },
  {
    ...
    mean: '당신에게 관심이 있어요',
    todo: '천천히 다가가도 괜찮아요',
    pose: (t, ex) => FACES.curious(ex == null ? 1 : ex),
  },
  {
    ...
    pose: (t, ex) => FACES.lipLick(ex == null ? 1 : ex),
  },
  {
    ...
    pose: (t, ex) => FACES.yawn(ex == null ? 1 : ex),
  },
  {
    ...
    pose: (t, ex) => FACES.lookAway(ex == null ? 1 : ex),
  },
  {
    ...
    todo: '지금 바로 물러나세요',
    pose: (t, ex) => FACES.whaleEye(ex == null ? 1 : ex),
  },
  {
    ...
    pose: (t, ex) => FACES.earsBack(ex == null ? 1 : ex),
  },
  {
    ...
    pose: (t, ex) => FACES.snarl(ex == null ? 1 : ex),
  },
  {
    ...
    mean: '정말 즐거워요',
    todo: '함께 즐거워해 주세요',
    pose: (t, ex) => FACES.joy(ex == null ? 1 : ex),
  },
  {
    ...
    pose: (t, ex) => FACES.panting(ex == null ? 1 : ex),
  },
];
